...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .xv-field--name  { animation: itemFadeUp 0.5s 0.52s ease both; }
  .xv-field--email { animation: itemFadeUp 0.5s 0.58s ease both; }
  .xv-field--pw    { animation: itemFadeUp 0.5s 0.64s ease both; }
  ...
  .xv-strength {
    ...
    margin-top: 0.45rem;
    animation: itemFadeUp 0.4s ease both;
  }
  .xv-strength-track {
    flex: 1; height: 3px; border-radius: 4px;
    background: rgba(120,100,230,0.14);
    overflow: hidden;
  }
  .xv-strength-bar {
    height: 100%; border-radius: 4px;
    transition: width 0.35s ease, background 0.35s ease;
    animation: barGrow 0.35s ease;
  }
  .xv-strength-label {
  ...
  .xv-terms {
    ...
    font-size: 0.78rem; color: #5c4f8a; line-height: 1.45;
    animation: itemFadeUp 0.5s 0.7s ease both;
  }
  .xv-terms input[type="checkbox"] {
    accent-color: #7c6fe0; width: 15px; height: 15px; cursor: pointer;
    margin-top: 1px; flex-shrink: 0;
  }
  .xv-terms label { cursor: pointer; }
  .xv-terms a { color: #8b7eeb; font-weight: 600; text-decoration: none; }
  .xv-terms a:hover { color: #c4b5fd; text-decoration: underline; }

  /* ── Fields gap ── */
  .xv-fields { display: flex; flex-direction: column; gap: 1rem; margin-bottom: 1.05rem; }

  /* ── Submit ── */
  .xv-submit {
    width: 100%; height: 2.95rem; margin-top: 0.9rem;
    ...
    color: #fff;
    animation: itemFadeUp 0.5s 0.76s ease both, btnGradient 6s ease infinite;
  ...
  .xv-trust {
    ...
    animation: itemFadeUp 0.5s 0.88s ease both;
  }
  .xv-trust-item {
...
function getStrength(pw) {
  if (!pw) return { score: 0, label: "", color: "#3a3257" }
  let score = 0
  ...
  if (score <= 3) return { score: 70, label: "Good", color: "#7c6fe0" }
...
export default function SignupPage() {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    if (loading || success || !agreed) return
    setLoading(true)
    ...
    <>
      ...
      <main className="xv-root" role="main">
        ...
        <div className="xv-content">
          ...
          {/* Card */}
          <div className="xv-card" role="region" aria-label="Create account">
            ...
            {success ? (
              ...
              <div className="xv-success" role="status" aria-live="polite">
                ...
                <p className="xv-success-text">Account created — welcome aboard!</p>
              </div>
            ) : (
              <>
                <h1 className="xv-heading">Create your account</h1>
                <p className="xv-subheading">Start building your startup today</p>
                ...
                <div className="xv-oauth">
                  ...
                  <button className="xv-oauth-btn xv-oauth-btn--gh" type="button" aria-label="Continue with GitHub">
                ...
                <form onSubmit={handleSubmit} noValidate>
                  <div className="xv-fields">
                    {/* Name */}
                    <div className="xv-field xv-field--name">
                      <label className="xv-label" htmlFor="xv-name">Full name</label>
                    ...
                    <div className="xv-field xv-field--pw">
                      ...
                      {password && (
                        <div className="xv-strength" aria-live="polite">
                          <div className="xv-strength-track">
                            <div
                              className="xv-strength-bar"
                              style={{ width: `${strength.score}%`, background: strength.color }}
                            />
                          </div>
                          <span className="xv-strength-label" style={{ color: strength.color }}>
                            {strength.label}
                          </span>
                        </div>
                      )}
                  ...
                  {/* Terms */}
                  <div className="xv-terms" style={{ marginBottom: "0.2rem" }}>
                    <input
                      id="xv-terms"
                      type="checkbox"
                      checked={agreed}
